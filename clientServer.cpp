...
void coverpage()                        
{
    ...
    glColor3f(0, 0, 1);
    drawstring(23.0 - 50, 85.0, 0.0, "ST JOSEPH ENGINEERING COLLEGE");
    glColor3f(0.7, 0, 1);
    ...
    glColor3f(1, 0, 0);
    drawstring(-33 - 50, -35, 0.0, "SRISHTI BHANDARKAR            4SO18CS114");
    glColor3f(1, 0, 0);
    drawstring(-33 - 50, -45, 0.0, "SUDHIKSHA S PRABHU            4SO18CS115");
    glColor3f(1, 0.5, 0);
    drawstring(83 - 50, -20, 0.0, "UNDER THE GUIDANCE OF :");
    glColor3f(1, 0, 0);
    drawstring(89 - 50, -35, 0.0, "MR. ROHAN DON SALINS");
    glColor3f(1, 0, 0);
